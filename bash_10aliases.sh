...
alias ffdhall='find . -type f -name "*.dhall"      | sources'
...
alias fgdhall='ffdhall | xargs grep -H -n '
...
alias plasma_stop='killall plasmashell'
alias plasma_restart='killall plasmashell && kstart plasmashell'
