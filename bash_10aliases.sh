...
alias  fgfile='fffile  | xargs grep --color -H -n '
alias   fgdir='ffdir   | xargs grep --color -H -n '
alias fgscala='ffscala | xargs grep --color -H -n '
alias  fgjava='ffjava  | xargs grep --color -H -n '
alias   fgsbt='ffsbt   | xargs grep --color -H -n '
alias   fgxml='ffxml   | xargs grep --color -H -n '
alias   fgpom='ffant   | xargs grep --color -H -n '
alias   fgpom='ffpom   | xargs grep --color -H -n '
alias   fgtxt='fftxt   | xargs grep --color -H -n '
alias    fgel='ffel    | xargs grep --color -H -n '
alias    fgrs='ffrs    | xargs grep --color -H -n '
alias    fgpy='ffpy    | xargs grep --color -H -n '
alias    fgsh='ffsh    | xargs grep --color -H -n '
alias    fgmd='ffmd    | xargs grep --color -H -n '
alias   fgrst='ffrst   | xargs grep --color -H -n '
alias    fgts='ffts    | xargs grep --color -H -n '
alias    fgjs='ffjs    | xargs grep --color -H -n '
alias  fgjson='ffjson  | xargs grep --color -H -n '
alias   fgcss='ffcss   | xargs grep --color -H -n '
alias  fgform='ffform  | xargs grep --color -H -n '
alias  fgconf='ffconf  | xargs grep --color -H -n '
alias   fgyml='ffyml   | xargs grep --color -H -n '
alias  fgyaml='ffyaml  | xargs grep --color -H -n '
alias  fgtoml='fftoml  | xargs grep --color -H -n '
alias  fgprop='ffprop  | xargs grep --color -H -n '
alias  fgdesc='ffdesc  | xargs grep --color -H -n '
alias  fgprof='ffprof  | xargs grep --color -H -n '
alias   fgcpp='ffcpp   | xargs grep --color -H -n '
alias   fgsql='ffsql   | xargs grep --color -H -n '
