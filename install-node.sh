...
&& /opt/developer/node-v${NODE_VERSION}-${NODE_ARCH}/bin/npm install -g --save typescript angular-cli \
&& /opt/developer/node-v${NODE_VERSION}-${NODE_ARCH}/bin/npm install -g --save gulp@3.9.0 typings@2.1.0 tslint@4.4.2
